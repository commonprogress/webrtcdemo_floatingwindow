...
class FloatingButtonService : LifecycleService() {
    ...
    private fun initWindowManager() {
        if (null == mWindowManager) {
            mWindowManager = this.applicationContext.getSystemService(Context.WINDOW_SERVICE) as WindowManager?
        }
    }
    ...
    private fun initLayoutParams() {
        ...
        mLayoutParams!!.packageName = this.applicationContext.packageName
...
//                or WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN)
    ...
    private fun initFloatWindowView() {
        mFloatView = LayoutInflater.from(this).inflate(R.layout.float_window_button, null)
...
//        }
    ...
    private fun removeFloatWindowView() {
        if (isShowFloating()) {
